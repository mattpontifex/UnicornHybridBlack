...
%   the issue and I'll see what I can do.
    ...
    if nargin < 1 % No file was identified in the call
        ...
        [filename, filepath] = uigetfile({'*.dap;*.DAP;*.rs3;*.RS3;*.cdt;*.CDT' 'All Curry data files'; '*.cdt;*.CDT' 'Curry 8 data files'; '*.dap;*.DAP;*.rs3;*.RS3' 'Curry 6 and 7 data files'}, 'Choose a Neuroscan Curry file -- pop_loadcurry()'); 
