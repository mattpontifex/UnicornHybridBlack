...
class EyeTribe:
	...
	def trackpupil(self):
		...
		"""Returns the most recent pupil information
		...
		if self._currentsample == None:
			...
			return (self._currentsample['Lpsize'],self._currentsample['Lpupilx'],self._currentsample['Lpupily'],self._currentsample['Rpsize'],self._currentsample['Rpupilx'],self._currentsample['Rpupily'])
