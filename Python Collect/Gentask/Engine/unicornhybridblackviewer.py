...
class Viewer():
    ...
    def prep(self):
        ...
        try:
            matplotlib.pyplot.get_current_fig_manager().set_window_title('Unicorn Hybrid Black')
        except:
            try:
            ...
            if boolcont:
                ...
                for cP in range(self.numberOfAcquiredChannels):
                    try:
                        ...
                        self.chanlables[self.numberOfAcquiredChannels-1-cP].set_bbox(dict(facecolor=newtexture, edgecolor=newtexture, boxstyle='square,pad=1.42'))
                    except:
